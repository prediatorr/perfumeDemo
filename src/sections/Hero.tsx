...
//   );
// }
// function SmokeVideo({ opacity = 0.28 }: { opacity?: number }) {
//   return (
//     <video
//       autoPlay
//       muted
...
//       }}
//     >
//       <source src="/videos/smoke-overlay.webm" type="video/webm" />
//     </video>
//   );
// }
    ...
    >
      ...
      <div
        style={{
          ...
          margin: "0 auto",
          background:
            "linear-gradient(to right, rgba(26,18,14,0.9) 0%, rgba(60,45,35,0.95) 40%, rgba(26,18,14,0.9) 100%)",
      ...
      <div
        style={{
          ...
          height: "85%",
          background:
            "linear-gradient(135deg, rgba(214,168,106,0.35) 0%, rgba(214,168,106,0.08) 25%, rgba(245,235,220,0.15) 40%, rgba(214,168,106,0.05) 55%, rgba(245,235,220,0.1) 70%, rgba(214,168,106,0.25) 100%)",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "60%",
            background:
              "linear-gradient(to top, rgba(90,60,30,0.6) 0%, rgba(140,100,50,0.3) 50%, transparent 100%)",
        ...
        <div
          style={{
            ...
            height: "100%",
            background:
              "linear-gradient(to bottom, rgba(245,235,220,0.4) 0%, rgba(214,168,106,0.3) 50%, rgba(245,235,220,0.2) 100%)",
          }}
        />
        {/* Label */}
        <div
        ...
        >
          ...
          AROMA
          <br />
          <span style={{ fontSize: "0.6em", opacity: 0.7 }}>1850</span>
        </div>
      </div>
      ...
      >
        ...
        <h1
          style={{
            ...
            transition:
              "opacity 1000ms cubic-bezier(0.16, 1, 0.3, 1) 1200ms, transform 1000ms cubic-bezier(0.16, 1, 0.3, 1) 1200ms",
          }}
        >
          We Do Not Create Perfume.
          <br />
        ...
        <p
          style={{
            ...
            transform: loaded ? "translateY(0)" : "translateY(30px)",
            transition:
              "opacity 1000ms cubic-bezier(0.16, 1, 0.3, 1) 1400ms, transform 1000ms cubic-bezier(0.16, 1, 0.3, 1) 1400ms",
          }}
        >
          An olfactory house crafting perfumes, attars, ambient fragrances, and
          sensory environments that linger long after the moment fades.
        </p>
        ...
        <div
          ...
          style={{
            ...
            transform: loaded ? "translateY(0)" : "translateY(30px)",
            transition:
              "opacity 1000ms cubic-bezier(0.16, 1, 0.3, 1) 1600ms, transform 1000ms cubic-bezier(0.16, 1, 0.3, 1) 1600ms",
          }}
        >
          <a
            href="#collections"
