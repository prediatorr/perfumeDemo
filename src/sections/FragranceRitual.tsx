        ...
        scrollTrigger: {
          ...
          onUpdate: (self) => {
            ...
            if (dotsRef.current) {
              ...
              dots.forEach((dot, i) => {
                const isActive = Math.floor(progress) === i || (progress >= scenes.length - 0.5 && i === scenes.length - 1);
                (dot as HTMLElement).style.background = isActive ? 'var(--amber-gold)' : 'rgba(255,255,255,0.2)';
            ...
            >
              ...
              <div
                style={{
                  position: 'absolute',
                  inset: 0,
                  background: 'linear-gradient(to right, rgba(7,7,7,0.4) 0%, transparent 30%, transparent 70%, rgba(7,7,7,0.4) 100%)',
                  zIndex: 1,
                }}
              />
          ...
          {scenes.map((_, i) => (
            <div
              ...
              style={{
                ...
                height: i === 0 ? '8px' : '6px',
                borderRadius: '50%',
                background: i === 0 ? 'var(--amber-gold)' : 'rgba(255,255,255,0.2)',
